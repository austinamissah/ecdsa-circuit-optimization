...
Output is keyed exactly as `apply_deep_strip_identity` expects, as `(kind, q_control2, q_control1,
...
distribution on head `6909d15`: two spikes at 1.0 and 0.5, **zero cold gates**, and charge spread so
