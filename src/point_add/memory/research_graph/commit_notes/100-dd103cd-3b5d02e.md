...
- Commit: `dd103cd091d8dd57dd87f3d5570a9a076767bfbc`
- Submission: `3b5d02e2-dd60-45cd-9a87-c63764ccfaa4`
- Solver/co-author: M3kko
- Date: 2026-06-02T09:01:12Z
- Public metric: score 2873320661 = 1697177 Toffoli x 1693 qubits
- Public diff: -9151501 (-0.09%)
...
Tags: `active-iters`, `apply-clean`, `branch-hosting`, `compare-width`, `cswap`, `dialog-gcd`, `partial-hosting`, `qubit-cut`, `reroll-island`, `round218-b5`, `round763-compressor`, `width-margin`

## Changed Files

- `src/point_add/memory/2026-06-02-cswap-floor-analysis.md` (+0/-68)
- `src/point_add/mod.rs` (+32/-124)
